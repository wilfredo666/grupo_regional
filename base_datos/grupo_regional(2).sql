...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-01-2019 a las 15:01:52
...
CREATE TABLE `costos_totales_atl` (
  ...
  `costo_total_proyecto_feevaiable` decimal(10,2) NOT NULL,
  `fee_ejecutado` decimal(10,2) NOT NULL,
  `fee_feevariable` decimal(10,2) NOT NULL,
  `costo_total_proyecto_mas_feevaiable` decimal(10,2) NOT NULL,
...
CREATE TABLE `hoja_costos_atl` (
  ...
  `codigo_hoja_costos` int(11) NOT NULL,
...
CREATE TABLE `producto_propio_taller_atl` (
  ...
  `costo_unitario` decimal(10,2) NOT NULL,
  `costo_total` decimal(10,2) NOT NULL,
  `precio_cotizado_sin_fee` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `hoja_costos_atl`
  ADD PRIMARY KEY (`id_hoja_costos_atl`);
...
--
ALTER TABLE `hoja_costos_atl`
  MODIFY `id_hoja_costos_atl` int(11) NOT NULL AUTO_INCREMENT;
