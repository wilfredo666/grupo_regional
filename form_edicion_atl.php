                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    while($row=mysqli_fetch_array($personal_directo)){
                                        ...
                                        echo '<td><input type="number" name="nrop[0]" id="nrop0" onkeyup="actualizarCostoTotal(0)" onClick="this.select();" class="form-control" value="'.$row[6].'"></td>';
                                        echo '<td><input type="text" name="tasa[0]" id="tasa0" onkeyup="actualizarCostoTotal(0)" readonly class="form-control" value="'.$row[7].'"></td>';
                                        echo '<td><input type="text" name="costop[0]" id="costop0" readonly class="form-control" value="'.$row[8].'"></td>';
                                        echo '<td><input type="text" name="precioC[0]" id="precioC0" onkeyup="actualizarCostoTotal(0)" onClick="this.select();" class="form-control" step="0.01" value="'.$row[9].'"></td>';
                                        echo '</tr>';
                                    }
                                    ?>
                                    <tr>
