                ...
                <table class="table table-sm" id="t1">
                    <tbody>
                        <tr>
                            ...
                            <td><label id="totalTi" ></label></td>
                            <td><label id="totalCa" ></label></td>
                            <td><label id="totalTa" ></label></td>
                            <td><label id="totalCo" ></label></td>
                ...
                <table class="table table-sm" id="tablita2">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td></td>
                            <td><button type="button" class="btn btn-success" onclick="addRow_t2();">agregar</button></td>
                        </tr>
                    </tbody>
                    </table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-success" onclick="addRow_t3();">agregar</button></td>
                        </tr>
                    </tbody>
                    </table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><button type="button" class="btn btn-success" onclick="addRow_t4()">agregar</button></td>
                        </tr>
                    </tbody>
                    </table> 
                    ...
                    <thead class="thead-light">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td scope="col"><button type="button" class="btn btn-success" onclick="addRow_t5()">agregar</button></td>
                        </tr>
                        </tbody>
                    </table>
