                ...
                <div class="col-9">
                    ...
                    <div id="contenedor_tabla">
                        <table>
                            <thead>
                                <tr>
                                    <th colspan="9">1) PERSONAL DIRECTO QUE INTERVIENE EN LA OPERACION</th>
                                </tr>
                                <tr>
                                    <td>DETALLE</td>
                                    ...
                                    <td>TASA PRESUPUESTARIA</td>
                                    <td>COSTO TOTAL PROGRAMADO DE M.O.D.</td>
                                    <td>PRECIO COTIZADO SIN F.E.E</td>
                                    <td></td>
                                </tr>
                            </thead>
                            <tbody>
