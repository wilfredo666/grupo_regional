                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-6 col-md-6">
                                    ...
                                    <a href="#" target="_blank" class="btn btn-warning btn-lg" role="button"><span class="glyphicon glyphicon-bookmark"></span> <br/>-</a>
                                    <a href="#" target="_blank" class="btn btn-primary btn-lg" role="button"><span class="glyphicon glyphicon-signal"></span> <br/>-</a>
                                    <a href="#" target="_blank" class="btn btn-primary btn-lg" role="button"><span class="glyphicon glyphicon-comment"></span> <br/>-</a>
                                </div>
                                <div class="col-xs-6 col-md-6">
